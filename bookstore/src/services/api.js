//API with latency, in-memory caching, and localStorage persistence.
//in-memory cache avoids repeated JSON parsing across route changes.

import seed from "../data/books.json";

const LS_KEY_BOOKS = "bookstore.books";
let memory = null; // in-memory cache
...
// Derive a lightweight category for demo filters
